...
of the stated minute volume for a 10-month-old infant. A no-slip
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.95\textwidth}{!}{\input{figures/assignment4_centerline_pressure.tex}}
...
lung; the left main bronchus formed the left group. With identical zero gauge
pressure at all outlets, the resulting unequal split reflects the resolved
geometric and hydraulic resistance of the branches.
